...
//   useEffect(() => {
//     inputRefs.current = inputRefs.current.slice(0, formData.codes.length);
//   }, [formData.codes]);
...
//   };
  ...
  const handleSubmit = (e) => {
    ...
    axios[method](
      url,
      { ...formData, codes: uniqueCodes, dayId },
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    )
              ...
              <tr key={index}>
                ...
                <td>
                  <input
                    ...
                    // onDoubleClick={() => handleCellDoubleClick(index, "code")}
                ...
                <td>
                  <input
                    ...
                    // onDoubleClick={() => handleCellDoubleClick(index, "weight")}
                    style={{ color: code.color || "black" }}
                    className={styles.input}
                  />
                </td>
                ...
                <td>
                  <input
                    ...
                    // onDoubleClick={() => handleCellDoubleClick(index, "m3")}
                    style={{ color: code.color || "black" }}
                    className={styles.input}
                  />
                </td>
                ...
                <td>
                  <select
                    ...
                    // onDoubleClick={() => handleCellDoubleClick(index, "color")}
                    className={styles.input}
                  >
